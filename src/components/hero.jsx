export function Hero() {
    return (
        ...
        <div className="w-6/12">
            <div className="flex w-1/2 font-[inter] w-1/2 font-medium text-[#4338CA] gap-4 items-center">
            <img className= "w-28 h-0 border border-[#3730A3]" src="./src/images/line.png"/>
                <a> Berk Şener</a>
            </div>
             <h1 className="font-[inter] text-7xl my-10">Creative thinker Minimalism lover</h1>
            <p className="font-[inter] text-lg font-normal font-bold leading-7 text-[#6B7280] ">Hi, I’m Almila. I’m a full-stack developer. 
            ...
            font-[inter] text-sm font-medium border border-[#3730A3] p-3 w-28 bg-[#3730A3]">Hire Me</button>
                <button className="rounded-md  text-[#3730A3]
